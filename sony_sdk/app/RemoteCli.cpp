...
int main()
{
    ...
    CrInt32u inputSshSupport = 0; // OFF
    {
        ...
        if (4 > vwords.size())
            vwords.push_back(inputIp); // last segment
        cntSeg = 0;
        CrInt32 inputAddr = 0;
    ...
    for (;;)
    {
        ...
        if (SDK::CrSdkControlMode_Remote == camera->get_sdkmode())
        {
            ...
            while (true)
            {
                ...
                if (action == TEXT("s"))
                { /* status display and device selection */
                    ...
                    cli::tout << std::endl
                              << "Selected camera number = [" << selectCamera << "]" << std::endl
                              << std::endl;
                        ...
                        else
                        {
                            ...
                            else
                            {
                                ...
                                if (TEXT("IP") == conn_type)
                                {
                                    ...
                                    id_select = ((TCHAR *)camera_info->GetId());
                ...
                { /* Shutter/Rec Operation Menu */
                    ...
                    while (true)
                    {
                        ...
                        else if (select == TEXT("2"))
                        { /* S1 Shooting */
                            camera->s1_shooting();
                        }
                        else if (select == TEXT("3"))
                        { /* AF Shutter */
                            camera->af_shutter();
                        }
                        else if (select == TEXT("4"))
                        { /* Continuous Shooting */
                            camera->continuous_shooting();
                        }
                        else if (select == TEXT("5"))
                        { /* Focus Bracket shooting */
                            camera->execute_focus_bracket();
                        }
                        else if (select == TEXT("6"))
                        { /* Movie Rec Button */
                            camera->execute_movie_rec();
                        }
                        else if (select == TEXT("7"))
                ...
                { /* Shooting Menu */
                    ...
                    while (true)
                    {
                        ...
                        { /* Set Focus Bracket Shot Num */
                            camera->set_focus_bracket_shot_num();
                        }
                        else if (select == TEXT("7"))
                        { /* Set Focus Bracket Focus Range*/
                            camera->set_focus_bracket_focus_range();
                        }
                        else if (select == TEXT("8"))
                        { /* Recording Setting */
                            camera->set_recording_setting();
                        }
                        else if (select == TEXT("9"))
                        { /* Image Stabilization Steady Shot((Still) */
                        ...
                        else if (select == TEXT("11"))
                        { /* Silent Mode */
                            camera->set_silent_mode();
                        }
                        else if (select == TEXT("12"))
                        ...
                        else if (select == TEXT("16"))
                        { /* Movie Shooting Mode */
                            camera->set_movie_shooting_mode();
                        }
                        else if (select == TEXT("17"))
                        { /* TimeShift Shooting */
                            camera->set_time_shift_shooting();
                        }
                        else if (select == TEXT("18"))
                ...
                {   /* Setup Menu */
                    ...
                    while (true)
                    {
                        ...
                        { /* Download camera setting file */
                            camera->do_download_camera_setting_file();
                        }
                        else if (select == TEXT("4"))
                        { /* Upload camera setting file */
                ...
                {   /* Other Menu */
                    ...
                    while (true)
                    {
                        ...
                        else if (select == TEXT("10"))
                        {
                            ...
                            else
                            {
                                ...
                                while (true)
                                {
                                    ...
                                    cli::tout << "\n";
                                    if (select == TEXT("1"))
                                    { /* Set Monitoring Delivery Setting */
                        ...
                        { /* Request Zoom And Focus Preset */
                            camera->execute_request_zoom_and_focus_preset();
                        }
                        else if (select == TEXT("12"))
                        { /* Get Zoom And Focus Preset */
